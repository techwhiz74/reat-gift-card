...
import { CanvasContext } from "../CanvasContainer.js";
...
const CanvasBorderComponent = (props) => {
  const { state, actions } = useContext(CanvasContext);
  const { dimension, position, id, type } = props;
...
export default CanvasBorderComponent;
